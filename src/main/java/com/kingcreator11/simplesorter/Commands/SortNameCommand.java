...
/**
 * The sort name sub command
 */
public class SortNameCommand extends SubCommand {

	/**
	 * Creates a new sort name command instance
	 * @param plugin
	 */
	public SortNameCommand(SimpleSorter plugin) {
